...
.time-left {
    ...
    <script>
      function ajax(){
        ...
        req.open('GET','adminchat.php',true);
        req.send();
      }
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
        ...
        <span class="icon-bar"></span>                        
         ...
         <img src="yabat.jpg" class="navbar-left" style="margin-top:1px;">
    ...
    <center>
      ...
      <center>
        ...
        <div class="form-group">
          <input type="text"  name="name" class="form-control" placeholder="Admin " value="Admin" readonly>
        </div>
     ...
     if(isset($_POST['submit'])){
      ...
      $insert = "INSERT INTO chats (name,msg) values ('$name','$msg')";
      $run = $db->query($insert);
      if ($run) {
        echo "<embed loop='false' src='chat.wav' hidden='true' autoplay='true'>";
        ?>
        <script>
          window.location('adminchat.php')
        </script>
        <?php
      }
     }
